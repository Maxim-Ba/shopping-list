      ...
      >
        {this.props.isOpenEditTitle &&
          <div className="container d-flex flex-column justify-content-center align-items-center mb-3">
            ...
            />
            <button className="btn btn-light mt-3" onClick={e => this.handleClickEdit(e)}>Применить</button>
        ...
        {this.props.isOpenCreateNewList &&
          <div className="container d-flex flex-column justify-content-center align-items-center mb-3">
            ...
            />
            <button className="btn btn-light mt-3" onClick={e => this.handleClickCreateNew(e)}>Применить</button>
        ...
        {this.props.deleteCurrentList &&
          <div className="container d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="bottom-submeny__wrapper-botton d-flex justify-content-around w-50 mt-2">
              <button className="btn btn-warning" onClick={e => this.handleClick(e)}>Удалить</button>
              <button className="btn btn-light" onClick={e => this.handleClick(e)}>Отена</button>
